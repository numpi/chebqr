...
fncts = { ...
    ...
    { '\sin(\frac{1}{x^2 + \frac{1}{4})', @(x) sin(1 ./ (x.^2 + 1/4)), true }, ...
    { '\sin(\frac{1}{x^2 + 10^{-2}})', @(x) sin(1 ./ (x.^2 + 1e-2)), true }, ...
    { '\texttt{randnfun}(1e-1)', randnfun(0.1), true }, ...
    { '\texttt{randnfun}(1e-2)', randnfun(0.01), true }, ...
    { '\texttt{randnfun}(1e-3)', randnfun(0.001), true }, ...
